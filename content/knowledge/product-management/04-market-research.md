...
> [!Note] >**Задача всех описанных выше методов — не получить точные значения, а оценить порядок.**
...
70. **Изучить альтернативные сегменты в своей отрасли.** Если до этого нужно было изучить отрасли-конкуренты, то теперь стоит посмотреть на тех, кто предлагает альтернативные решения в вашей отрасли.
    ![[assets/Pasted image 20250121233334.webp]]
...
![[assets/Pasted image 20250121232904.webp]]
![[assets/Pasted image 20250121234931.webp]]
...
1. **Потенциальные клиенты не станут реальными, пока вы не дадите им возможность ответить отказом на ваше предложение.** Неопределенность хуже всего
1. **Единственное, о чем люди говорят с еще большей охотой, чем о себе, — это их проблемы.** Проявив внимание к проблемам собеседника и мелочам, происходящим в его жизни, вы уже становитесь более интересны, чем 99% людей, с которыми он когда либо встречался.
1. Пока вы не настроитесь на поиск четко сформулированных, непротиворечивых проблем и целей, ваш клиентский сегмент останется размытым. Для общения с клиентами необходима более детальная сегментация, чем для продвижения бизнеса в целом.
