...
### Подход работ пользователя (JTBD, Jobs To Be Done)

> [!Note] > **Главное в Jobs To Be Done—знать и эффективнее выполнять задачи клиентов.**
...
- [Шаблон JTBD-интервью для поиска сегмента и изучения высоко- и низкоуровневых работ](https://ivanzamesin.notion.site/v3-1-JTBD-Interview-Template-for-Segment-Discovery-AND-High-level-Low-level-Jobs-Exploration-0f3ee81fea374bfdb83c1fe33310b7cc)
- [Шаблон B2C JTBD-интервью для поиска продукта](https://ivanzamesin.notion.site/B2C-JTBD-93bbaf51624745469990b1bb4d44a8af)
- [Скрипт B2C JTBD-интервью для поиска продукта](https://ivanzamesin.notion.site/B2C-JTBD-interview-script-for-discovering-a-product-f80f886e6acf435d8669edcd4c7505cc)
...
- [Скрипт B2B JTBD-интервью для поиска клиентского сегмента](https://ivanzamesin.notion.site/v2-4-B2B-JTBD-interview-script-for-discovering-a-customer-segment-54c0a6edcb7f4721ace14b58da8766b4)
...
- примерное соотношение количества людей в сегментах. Если есть возможность, посчитайте примерное количество людей в абсолютных значениях.

#### Сравнение JTBD с другими фреймворками

Сравнение JTBD и User Story:
...
#### Быстрые итеративные тесты и оценка (Rapid Iterative Testing Evaluation, RITE)
...
#### Тест самого рискованного предположения (Riskiest Assumption Test, RAT)
...
Тест самого рискованного предположения (RAT) — это инструмент выделения и проверки этих рискованных предположений. Он состоит всего из трёх шагов:
...
Совместный анализ (Conjoint Analysis) - это как создание коктейля, где ты выясняешь, какие ингредиенты (или характеристики продукта) и в каком количестве нужны твоим клиентам. Ты предлагаешь людям разные варианты смартфонов с разными сочетаниями характеристик и спрашиваешь их мнение.
...
##### 1. **Стадия вывода на рынок (Introduction Stage)**

##### 2. **Стадия роста (Growth Stage)**

- **[Расширение рынка (Market Expansion)](https://productmanagement.world/Product+Market/Market+Expansion).** Ищите возможности расширить рыночный охват продукта и выйти в новые клиентские сегменты.
- **[Дифференциация продукта (Product Differentiation)](https://productmanagement.world/Product+Strategy/Product+Differentiation).** Постоянно улучшайте функции и возможности продукта, чтобы отличаться от конкурентов и поддерживать темп роста.
- **Каналы дистрибуции (Distribution Channels).** Развивайте и настраивайте эффективные каналы дистрибуции, чтобы повысить доступность продукта.
- **Поддержка клиентов (Customer Support).** Инвестируйте в поддержку клиентов, чтобы отвечать на вопросы, помогать пользователям и формировать лояльность.

##### 3. **Стадия зрелости (Maturity Stage)**

##### 4. **Стадия спада (Decline Stage)**
...
210. **MVP из готовых частей (Piecemeal MVP)**. Вместо того чтобы разрабатывать каждый элемент продукта с нуля, команды комбинируют доступные компоненты, чтобы быстро создать работоспособную версию продукта. Сюда же входят no-code и low-code инструменты разработки.
...
212. **MVP ложной двери (Fake Door MVP)**. Это метод тестирования интереса к потенциальному продукту или функции, при котором компания создает иллюзию наличия этого продукта или функции, хотя на самом деле она еще не разработана. Это как когда в магазине висит реклама товара, которого на самом деле нет в наличии, чтобы посмотреть, сколько людей спросят о нем.
...
215. **MVP email-кампания**. Это когда компания запускает очень простую и базовую рассылку по электронной почте, чтобы проверить интерес к новому продукту или услуге.
...
### Петля роста продукта (Growth Loop)
...
#### Известные петли роста (Famous Growth Loops)
...
[Шаблон матрицы RACI (RACI Matrix Template)](https://www.smartsheet.com./content/raci-templates)
...
##### Проверка здоровья матрицы (Health Check)
