...
#### Видение продукта (Product vision) и стратегия (strategy)
...
#### Как сделать конкуренцию несущественной: стратегия голубого океана (Blue Ocean Strategy) У. Чана Кима и Рене Моборна
...
#### «Хорошая стратегия, плохая стратегия» (Good Strategy, Bad Strategy)
...
![[assets/Pasted image 20250204165924.webp]]
![[assets/Pasted image 20250204170505.png]]

#### Стратегия запуска продукта (Product launch strategy): как вывести новый продукт за 5 шагов

#### 4 частые причины провала запуска продукта

#### **Как запустить продукт за 5 шагов**

![[assets/Pasted image 20250204174955.png]]

#### По Майклу Портеру, хорошая стратегия должна проходить следующие 5 проверок

238. Уникальное ценностное предложение (Unique Value Proposition)
     Проверьте себя:

### Канва ценностного предложения (Value Proposition Canvas)

![[assets/Pasted image 20250204195951.png]]1. Справа— **Клиенты**: - **Задачи**: Что клиенты пытаются сделать? Например, если у вас приложение для фитнеса, их задача — поддерживать себя в форме. - **Боли**: С какими проблемами они сталкиваются? Возможно, им сложно найти время для тренировок. - **Выгоды:** Чего они хотят достичь? Например, они хотят чувствовать себя здоровее.
...
Как читать канву ценностного предложения (Value Proposition Canvas)
...
[Навигатор бизнес-моделей (Business Model Navigator)](https://businessmodelnavigator.com)
...
#### Бережливая канва (Lean Canvas)

![[assets/Pasted image 20250208201151.png]]

> Бережливая канва (Lean Canvas) — это адаптация канвы бизнес-модели (Business Model Canvas), специально разработанная для стартапов и новых бизнес-проектов.

#### Отличия канвы бизнес-модели (Business Model Canvas) и бережливой канвы (Lean Canvas)
...
> Дорожная карта (Roadmap) — это план, который показывает, какие шаги нужно предпринять, чтобы добиться определенной цели или развить проект. Роадмап похож на карту путешествия для продукта или проекта. В ней указываются основные этапы или вехи, когда и как они должны быть достигнуты.

#### Зачем нужна дорожная карта (Roadmap)?

248. **Стратегическое выравнивание (Strategic alignment)**

249. **Коммуникация со стейкхолдерами (Stakeholder communication)**

250. **Планирование ресурсов (Resource planning)**

#### Шаблоны дорожных карт (Roadmap Templates)
...
![[assets/Pasted image 20250209224753.webp]]
...
6.  **Оценка возможностей**(Opportunity Scoring).
    Фреймворк основываются на правиле, что люди покупают продукты и услуги, чтобы выполнить определенную работу. То есть, это ожидаемый результат. Концепция jobs-to-be-done Клейтона Кристенсена разделяет эту линию мышления, и это была горячая тема, которая собрала много внимания в последнее время.
        ...
        ![[assets/Pasted image 20250209230756.png]]
...
1. Существует горизонтальная ось, представляющая **последовательность использования**;
   ...
   1. Группы связанных историй пользователей могут быть сгруппированы как « *Activities*» (Действия):
...
![[assets/Pasted image 20250212154601.webp]]
...
> 1. при планировании *нового сервиса*

#### CJM для существующего сервиса

276. Составляем персону
     ![[assets/Pasted image 20250213142804.webp]]
...
282.  Каковы цели проекта, какую выгоду он даст бизнесу.
283.  Как заказчик видит процесс работы сервиса (возможно наша будущая CJM изменит это представление, но нам важно узнать как заказчик представляет работу сервиса изнутри в данный момент).
284.  Какие есть ограничения в работе сервиса не связанные с разработкой. Например, у заказчика небольшой автопарк или нет возможности нанять специалиста техподдержки.
285.  Можем ли мы сформулировать KPI проекта уже сейчас, например, количество заказов в месяц.
286.  Каковы сроки создания сервиса.
287.  Какая команда будет над этим работать, какие существуют технические ограничения.

288.  **Создание прото-персоны**.
...
284. ![[assets/Pasted image 20250213150944.png]]
     Базовый шаблон составления любой карты

285. **Сервисный чертеж (Service Blueprint)**
...
287. Карта пользовательских историй (User Stories Map)
