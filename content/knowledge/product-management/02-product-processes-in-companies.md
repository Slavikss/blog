...
description: "Раздел из Product Management Cheatsheet: Как отстроены продуктовые процессы в компаниях"
tags:
  - knowledge
  - product-management
  - cheatsheet
...
- Prev: [[knowledge/product-management/01-who-is-product-manager|Кто такой product manager]]
- [[pm-study|Наверх: Product Management Cheatsheet]]
- Next: [[knowledge/product-management/03-idea-discovery-and-validation|Поиск идей]]
