---
title: "Манифест Agile (Agile Manifesto)"
description: "Раздел из шпаргалки по управлению проектами (Project Management): манифест Agile"
tags:
  - knowledge
  - project-management
  - cheatsheet
...
- Назад: [[knowledge/project-management/19-quality-management|Основы управления качеством]]
- [[project-management-study|Наверх: Шпаргалка по управлению проектами (Project Management)]]
- Далее: [[knowledge/project-management/21-scrum-principles|Базовые принципы Скрама (Scrum)]]
