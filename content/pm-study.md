...
>[!todo]-  Полезные Ресурсы, откуда бралась информация(список ими не ограничивается)
>
>Исследования
...
14. Draw a square in the middle of a large piece of paper or flip chart, and write your central theme in the middle.
15. Using this central theme as a foundation, think of eight ideas that are related and create eight new squares around the outside of your central theme, writing the new ideas inside.
16. For each of these eight new themes, think of eight further related schemes, again adding these to the paper in separate squares when done.
17. Continue as far as you feel is relevant.
...
44. **Оценить методы продвижения и примерные бюджеты.** Методы продвижения оценивают по площадкам, где представлен бренд. Рекламные бюджеты без погрешности узнать невозможно. Некоторые маркетинговые сервисы дают вилку бюджета на контекстную рекламу, но точная информация отсутствует.
...
Возможные причины:
58.  Задача не имеет решения. Вспомним одно из положений ТРИЗ: "Если условия задачи не нарушают законов природы, то задача имеет решение". Рассмотрите, какие конкретно законы нарушены.
59. Не понята задача. Еще несколько раз прочитайте условия задачи. Не торопясь ответьте на все вопросы подготовки задачи к решению, изложенные в разделе "Как правильно формулировать задачи?" Поговорите с задачедателем.
...
293. **Первый закон Паркинсона**. гласит, что количество времени, которое вы отводите на выполнение задачи, равно количеству времени, которое эта задача займет. Другими словами, работа заполняет ***всё*** отведенное на нее время.
...
![[files/Pasted image 20250223202337.png]]
- тема
- инкапсулированные смысловые части
- лицо слайда(см.ниже)
![[files/Pasted image 20250223202618.png]]
## Команда
### Управление ожиданиями стейкхолдеров
![[files/Pasted image 20250223220248.png]]
